...
[Alphabetical index](../_Index.md) · [View on Wiktionary](https://en.wiktionary.org/wiki/Reconstruction:Proto-Germanic/skip%C4%85)

## Proto-Germanic

**Reconstruction:** *skipą
...
**Directly mentioned PIE form(s):** *skey-, *skēi-b-
...
1. _(neuter, reconstruction)_ ship
2. _(neuter, possibly, reconstruction)_ any hollow or concave manmade object
3. _(Germanic, West, neuter, reconstruction)_ vessel, tub
...
|---|---|
| a-stem | class |
| skipą | nominative, singular |
| skipō | nominative, plural |
| skipą | singular, vocative |
| skipō | plural, vocative |
| skipą | accusative, singular |
| skipō | accusative, plural |
| skipas | genitive, singular |
| skipis | genitive, singular |
| skipǫ̂ | genitive, plural |
| skipai | dative, singular |
| skipamaz | dative, plural |
| skipō | instrumental, singular |
| skipamiz | instrumental, plural |
...
- **Proto-West Germanic:** *skip
  ...
  - **Old Frisian:** skip
    - **North Frisian:** 
    - **Saterland Frisian:** Skip
    - **Saterland Frisian:** Schip
    - **West Frisian:** skip
  - **Old Saxon:** skip
    - **Middle Low German:** schip
      - **Low German:** Schipp
        - **German Low German:** Schipp
        - **German Low German:** Schip
        - **Plautdietsch:** Schepp
    - **Middle Low German:** schep
      - **Low German:** Schipp
        - **German Low German:** Schipp
        - **German Low German:** Schip
        - **Plautdietsch:** Schepp
  ...
  - **Old High German:** skif
    - **Middle High German:** schif
      - **Bavarian:** Schiff
      - **Bavarian:** Scheff
      - **Central Franconian:** Scheff
        - **Hunsrik:** Schiff
        - **Luxembourgish:** Schëff
      - **Central Franconian:** Schoff
        - **Hunsrik:** Schiff
        - **Luxembourgish:** Schëff
      - **Central Franconian:** Schöff — _parts of Eifel; southwestern Ripuarian_
        - **Hunsrik:** Schiff
        - **Luxembourgish:** Schëff
      - **German:** Schiff
      - **Vilamovian:** śejf
    ...
    - **Middle High German:** schëf
      ...
      - **Vilamovian:** siejft
      - **Yiddish:** שיף
    - **Middle English:** skif — _borrowed_ — _through a non-Germanic route_
      - **English:** skiff

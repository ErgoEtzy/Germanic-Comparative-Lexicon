...
[Alphabetical index](../_Index.md) · [View on Wiktionary](https://en.wiktionary.org/wiki/Reconstruction:Proto-Germanic/-anaz)
...
1. _(morpheme, reconstruction)_ -ruler (attached to various words to create a term meaning ”one who leads X”).
2. _(morpheme, reconstruction)_ Forms the past participle of strong verbs.
...
|---|---|
| a-stem | class |
| -anaz | nominative, singular |
| -anōz | nominative, plural |
| -anōs | nominative, plural |
| -an | singular, vocative |
| -anōz | plural, vocative |
| -anōs | plural, vocative |
| -aną | accusative, singular |
| -ananz | accusative, plural |
| -anas | genitive, singular |
| -anis | genitive, singular |
| -anǫ̂ | genitive, plural |
| -anai | dative, singular |
| -anamaz | dative, plural |
| -anō | instrumental, singular |
| -anamiz | instrumental, plural |
| *-naz | alternative |

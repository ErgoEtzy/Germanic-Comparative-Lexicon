...
[Alphabetical index](../_Index.md) · [View on Wiktionary](https://en.wiktionary.org/wiki/Reconstruction:Proto-Germanic/rattaz)

## Proto-Germanic

**Reconstruction:** *rattaz

### Etymology

The origin of this word (and the related *rattō) is uncertain. It may derive from Proto-Indo-European *Hreh₃d- (“to scrape, gnaw, scratch”) (whence e.g. Latin rōdō and possibly also, but more indirectly, Latin rādō and its derivatives (i.e. raze)), but this is disputed, and Klein says that such a connection does not exist. In view of Welsh rhathu (“to scrape; to chafe”) (via Proto-Brythonic *rėθid and earlier *ratteti from Proto-Celtic *rasdeti (“to scrape; to scratch”), cognate with Latin rādō (“to scrape”)), an ancient Celtic derivative noun like *rattos could conceivably be the source. The word may also go back to an unknown substrate language.
...
1. _(masculine, reconstruction)_ rat
...
|---|---|
| a-stem | class |
| rattaz | nominative, singular |
| rattōz | nominative, plural |
| rattōs | nominative, plural |
| ratt | singular, vocative |
| rattōz | plural, vocative |
| rattōs | plural, vocative |
| rattą | accusative, singular |
| rattanz | accusative, plural |
| rattas | genitive, singular |
| rattis | genitive, singular |
| rattǫ̂ | genitive, plural |
| rattai | dative, singular |
| rattamaz | dative, plural |
| rattō | instrumental, singular |
| rattamiz | instrumental, plural |

</details>

### Germanic descendants

- **Proto-West Germanic:** *ratt
  - **Old English:** rætt
  ...
  - **Old Dutch:** *rato
    - **Middle Dutch:** ratte
      - **Dutch:** rat
        - **Afrikaans:** rot
      - **Dutch:** rot — _dialectal; Northern Dutch_
        - **Afrikaans:** rot
      - **Limburgish:** rat
  - **Old Dutch:** *roto
    - **Middle Dutch:** ratte
  ...
  - **Old High German:** rato
    - **Middle High German:** ratte
      ...
      - **Vilamovian:** rot
      - **Vilamovian:** rott
    - **Middle High German:** rate
      - **German:** Ratte
      - **Luxembourgish:** Rat
      - **Vilamovian:** rot
      - **Vilamovian:** rott
- **Proto-West Germanic:** *ratō
  - **Old English:** rætt
    - **Middle English:** ratte
      - **English:** rat
      - **Scots:** ratt
